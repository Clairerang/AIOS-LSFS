...
class LinkAgent(BaseAgent):
    ...
    def manual_workflow(self):
        workflow = [
            {"action_type": "operate_file", "action": "identify the location of the file to share", "tool_use": []},
            {"action_type": "operate_file", "action": "generate the shareable link for this file ", "tool_use": []},
        ]
        return workflow
